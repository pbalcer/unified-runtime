...
typedef ur_result_t(UR_APICALL *ur_pfnPlatformGet_t)(uint32_t,
...
typedef ur_result_t(UR_APICALL *ur_pfnContextCreate_t)(uint32_t,
                                                       ur_device_handle_t *,
                                                       ur_context_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnEventCreateWithNativeHandle_t)(
    ur_native_handle_t, ur_context_handle_t, ur_event_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnProgramCreate_t)(
    ur_context_handle_t, uint32_t, const ur_module_handle_t *, const char *,
    ur_program_handle_t *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urProgramCreateWithBinary
typedef ur_result_t(UR_APICALL *ur_pfnProgramCreateWithBinary_t)(
    ur_context_handle_t, ur_device_handle_t, size_t, const uint8_t *,
    ur_program_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnProgramSetSpecializationConstant_t)(
    ur_program_handle_t, uint32_t, size_t, const void *);
...
typedef ur_result_t(UR_APICALL *ur_pfnModuleCreate_t)(
    ur_context_handle_t, const void *, size_t, const char *,
    ur_modulecreate_callback_t, void *, ur_module_handle_t *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urModuleRetain
typedef ur_result_t(UR_APICALL *ur_pfnModuleRetain_t)(ur_module_handle_t);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urModuleRelease
typedef ur_result_t(UR_APICALL *ur_pfnModuleRelease_t)(ur_module_handle_t);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urModuleGetNativeHandle
typedef ur_result_t(UR_APICALL *ur_pfnModuleGetNativeHandle_t)(
    ur_module_handle_t, ur_native_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnModuleCreateWithNativeHandle_t)(
    ur_native_handle_t, ur_context_handle_t, ur_module_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnGetModuleProcAddrTable_t)(
    ur_api_version_t, ur_module_dditable_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnKernelCreateWithNativeHandle_t)(
    ur_native_handle_t, ur_context_handle_t, ur_kernel_handle_t *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urKernelSetArgValue
typedef ur_result_t(UR_APICALL *ur_pfnKernelSetArgValue_t)(ur_kernel_handle_t,
                                                           uint32_t, size_t,
                                                           const void *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urKernelSetArgLocal
typedef ur_result_t(UR_APICALL *ur_pfnKernelSetArgLocal_t)(ur_kernel_handle_t,
                                                           uint32_t, size_t);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urKernelSetArgPointer
typedef ur_result_t(UR_APICALL *ur_pfnKernelSetArgPointer_t)(ur_kernel_handle_t,
                                                             uint32_t, size_t,
                                                             const void *);
...
typedef ur_result_t(UR_APICALL *ur_pfnKernelSetExecInfo_t)(
    ur_kernel_handle_t, ur_kernel_exec_info_t, size_t, const void *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urKernelSetArgSampler
typedef ur_result_t(UR_APICALL *ur_pfnKernelSetArgSampler_t)(
    ur_kernel_handle_t, uint32_t, ur_sampler_handle_t);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urKernelSetArgMemObj
typedef ur_result_t(UR_APICALL *ur_pfnKernelSetArgMemObj_t)(ur_kernel_handle_t,
                                                            uint32_t,
                                                            ur_mem_handle_t);
...
typedef ur_result_t(UR_APICALL *ur_pfnSamplerCreate_t)(
    ur_context_handle_t, const ur_sampler_property_t *, ur_sampler_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnSamplerCreateWithNativeHandle_t)(
    ur_native_handle_t, ur_context_handle_t, ur_sampler_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnMemBufferCreate_t)(ur_context_handle_t,
                                                         ur_mem_flags_t, size_t,
                                                         void *,
                                                         ur_mem_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnEnqueueUSMMemset_t)(
    ur_queue_handle_t, void *, int8_t, size_t, uint32_t,
    const ur_event_handle_t *, ur_event_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnEnqueueUSMMemAdvise_t)(
    ur_queue_handle_t, const void *, size_t, ur_mem_advice_t,
    ur_event_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnEnqueueUSMMemset2D_t)(
    ur_queue_handle_t, void *, size_t, int, size_t, size_t, uint32_t,
    const ur_event_handle_t *, ur_event_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnTearDown_t)(void *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urGetLastResult
typedef ur_result_t(UR_APICALL *ur_pfnGetLastResult_t)(ur_platform_handle_t,
                                                       const char **);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urInit
typedef ur_result_t(UR_APICALL *ur_pfnInit_t)(ur_device_init_flags_t);
...
typedef ur_result_t(UR_APICALL *ur_pfnQueueCreate_t)(
    ur_context_handle_t, ur_device_handle_t, const ur_queue_property_t *,
    ur_queue_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnQueueGetNativeHandle_t)(
    ur_queue_handle_t, ur_native_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnQueueCreateWithNativeHandle_t)(
    ur_native_handle_t, ur_context_handle_t, ur_queue_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnDevicePartition_t)(
    ur_device_handle_t, const ur_device_partition_property_t *, uint32_t,
    ur_device_handle_t *, uint32_t *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urDeviceSelectBinary
typedef ur_result_t(UR_APICALL *ur_pfnDeviceSelectBinary_t)(ur_device_handle_t,
                                                            const uint8_t **,
                                                            uint32_t,
                                                            uint32_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnDeviceCreateWithNativeHandle_t)(
    ur_native_handle_t, ur_platform_handle_t, ur_device_handle_t *);
