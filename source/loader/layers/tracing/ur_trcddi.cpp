...
urContextCreate(
    ...
    ur_context_create_params_t params = {&DeviceCount, &phDevices, &phContext};
    uint64_t instance = context.notify_begin(0, "urContextCreate", &params);

    ur_result_t result = pfnCreate(DeviceCount, phDevices, phContext);

    context.notify_end(0, "urContextCreate", &params, &result, instance);
...
urContextRetain(
    ...
    uint64_t instance = context.notify_begin(1, "urContextRetain", &params);

    ur_result_t result = pfnRetain(hContext);

    context.notify_end(1, "urContextRetain", &params, &result, instance);
...
urContextRelease(
    ...
    uint64_t instance = context.notify_begin(2, "urContextRelease", &params);

    ur_result_t result = pfnRelease(hContext);

    context.notify_end(2, "urContextRelease", &params, &result, instance);
...
urContextGetInfo(
    ...
    uint64_t instance = context.notify_begin(3, "urContextGetInfo", &params);

    ur_result_t result = pfnGetInfo(hContext, ContextInfoType, propSize, pContextInfo, pPropSizeRet);

    context.notify_end(3, "urContextGetInfo", &params, &result, instance);
...
urContextGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(4, "urContextGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hContext, phNativeContext);

    context.notify_end(4, "urContextGetNativeHandle", &params, &result, instance);
...
urContextCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(5, "urContextCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeContext, phContext);

    context.notify_end(5, "urContextCreateWithNativeHandle", &params, &result, instance);
...
urContextSetExtendedDeleter(
    ...
    uint64_t instance = context.notify_begin(6, "urContextSetExtendedDeleter", &params);

    ur_result_t result = pfnSetExtendedDeleter(hContext, pfnDeleter, pUserData);

    context.notify_end(6, "urContextSetExtendedDeleter", &params, &result, instance);
...
urEnqueueKernelLaunch(
    ...
    uint64_t instance = context.notify_begin(7, "urEnqueueKernelLaunch", &params);
    ...
    context.notify_end(7, "urEnqueueKernelLaunch", &params, &result, instance);
...
urEnqueueEventsWait(
    ...
    uint64_t instance = context.notify_begin(8, "urEnqueueEventsWait", &params);

    ur_result_t result = pfnEventsWait(hQueue, numEventsInWaitList, phEventWaitList, phEvent);

    context.notify_end(8, "urEnqueueEventsWait", &params, &result, instance);
...
urEnqueueEventsWaitWithBarrier(
    ...
    uint64_t instance = context.notify_begin(9, "urEnqueueEventsWaitWithBarrier", &params);

    ur_result_t result = pfnEventsWaitWithBarrier(hQueue, numEventsInWaitList, phEventWaitList, phEvent);

    context.notify_end(9, "urEnqueueEventsWaitWithBarrier", &params, &result, instance);
...
urEnqueueMemBufferRead(
    ...
    uint64_t instance = context.notify_begin(10, "urEnqueueMemBufferRead", &params);
    ...
    context.notify_end(10, "urEnqueueMemBufferRead", &params, &result, instance);
...
urEnqueueMemBufferWrite(
    ...
    uint64_t instance = context.notify_begin(11, "urEnqueueMemBufferWrite", &params);
    ...
    context.notify_end(11, "urEnqueueMemBufferWrite", &params, &result, instance);
...
urEnqueueMemBufferReadRect(
    ...
    uint64_t instance = context.notify_begin(12, "urEnqueueMemBufferReadRect", &params);
    ...
    context.notify_end(12, "urEnqueueMemBufferReadRect", &params, &result, instance);
...
urEnqueueMemBufferWriteRect(
    ...
    uint64_t instance = context.notify_begin(13, "urEnqueueMemBufferWriteRect", &params);
    ...
    context.notify_end(13, "urEnqueueMemBufferWriteRect", &params, &result, instance);
...
urEnqueueMemBufferCopy(
    ...
    uint64_t instance = context.notify_begin(14, "urEnqueueMemBufferCopy", &params);
    ...
    context.notify_end(14, "urEnqueueMemBufferCopy", &params, &result, instance);
...
urEnqueueMemBufferCopyRect(
    ...
    uint64_t instance = context.notify_begin(15, "urEnqueueMemBufferCopyRect", &params);
    ...
    context.notify_end(15, "urEnqueueMemBufferCopyRect", &params, &result, instance);
...
urEnqueueMemBufferFill(
    ...
    uint64_t instance = context.notify_begin(16, "urEnqueueMemBufferFill", &params);
    ...
    context.notify_end(16, "urEnqueueMemBufferFill", &params, &result, instance);
...
urEnqueueMemImageRead(
    ...
    uint64_t instance = context.notify_begin(17, "urEnqueueMemImageRead", &params);
    ...
    context.notify_end(17, "urEnqueueMemImageRead", &params, &result, instance);
...
urEnqueueMemImageWrite(
    ...
    uint64_t instance = context.notify_begin(18, "urEnqueueMemImageWrite", &params);
    ...
    context.notify_end(18, "urEnqueueMemImageWrite", &params, &result, instance);
...
urEnqueueMemImageCopy(
    ...
    uint64_t instance = context.notify_begin(19, "urEnqueueMemImageCopy", &params);
    ...
    context.notify_end(19, "urEnqueueMemImageCopy", &params, &result, instance);
...
urEnqueueMemBufferMap(
    ...
    uint64_t instance = context.notify_begin(20, "urEnqueueMemBufferMap", &params);
    ...
    context.notify_end(20, "urEnqueueMemBufferMap", &params, &result, instance);
...
urEnqueueMemUnmap(
    ...
    uint64_t instance = context.notify_begin(21, "urEnqueueMemUnmap", &params);

    ur_result_t result = pfnMemUnmap(hQueue, hMem, pMappedPtr, numEventsInWaitList, phEventWaitList, phEvent);

    context.notify_end(21, "urEnqueueMemUnmap", &params, &result, instance);
...
urEnqueueUSMMemset(
    ...
    ur_enqueue_usm_memset_params_t params = {&hQueue, &ptr, &byteValue, &count, &numEventsInWaitList, &phEventWaitList, &phEvent};
    uint64_t instance = context.notify_begin(22, "urEnqueueUSMMemset", &params);

    ur_result_t result = pfnUSMMemset(hQueue, ptr, byteValue, count, numEventsInWaitList, phEventWaitList, phEvent);

    context.notify_end(22, "urEnqueueUSMMemset", &params, &result, instance);
...
urEnqueueUSMMemcpy(
    ...
    uint64_t instance = context.notify_begin(23, "urEnqueueUSMMemcpy", &params);

    ur_result_t result = pfnUSMMemcpy(hQueue, blocking, pDst, pSrc, size, numEventsInWaitList, phEventWaitList, phEvent);

    context.notify_end(23, "urEnqueueUSMMemcpy", &params, &result, instance);
...
urEnqueueUSMPrefetch(
    ...
    uint64_t instance = context.notify_begin(24, "urEnqueueUSMPrefetch", &params);

    ur_result_t result = pfnUSMPrefetch(hQueue, pMem, size, flags, numEventsInWaitList, phEventWaitList, phEvent);

    context.notify_end(24, "urEnqueueUSMPrefetch", &params, &result, instance);
...
urEnqueueUSMMemAdvise(
    ...
    uint64_t instance = context.notify_begin(25, "urEnqueueUSMMemAdvise", &params);

    ur_result_t result = pfnUSMMemAdvise(hQueue, pMem, size, advice, phEvent);

    context.notify_end(25, "urEnqueueUSMMemAdvise", &params, &result, instance);
...
urEnqueueUSMFill2D(
    ...
    uint64_t instance = context.notify_begin(26, "urEnqueueUSMFill2D", &params);
    ...
    context.notify_end(26, "urEnqueueUSMFill2D", &params, &result, instance);
...
urEnqueueUSMMemset2D(
    ...
    uint64_t instance = context.notify_begin(27, "urEnqueueUSMMemset2D", &params);

    ur_result_t result = pfnUSMMemset2D(hQueue, pMem, pitch, value, width, height, numEventsInWaitList, phEventWaitList, phEvent);

    context.notify_end(27, "urEnqueueUSMMemset2D", &params, &result, instance);
...
urEnqueueUSMMemcpy2D(
    ...
    uint64_t instance = context.notify_begin(28, "urEnqueueUSMMemcpy2D", &params);
    ...
    context.notify_end(28, "urEnqueueUSMMemcpy2D", &params, &result, instance);
...
urEnqueueDeviceGlobalVariableWrite(
    ...
    uint64_t instance = context.notify_begin(29, "urEnqueueDeviceGlobalVariableWrite", &params);
    ...
    context.notify_end(29, "urEnqueueDeviceGlobalVariableWrite", &params, &result, instance);
...
urEnqueueDeviceGlobalVariableRead(
    ...
    uint64_t instance = context.notify_begin(30, "urEnqueueDeviceGlobalVariableRead", &params);
    ...
    context.notify_end(30, "urEnqueueDeviceGlobalVariableRead", &params, &result, instance);
...
urEventGetInfo(
    ...
    uint64_t instance = context.notify_begin(31, "urEventGetInfo", &params);

    ur_result_t result = pfnGetInfo(hEvent, propName, propValueSize, pPropValue, pPropValueSizeRet);

    context.notify_end(31, "urEventGetInfo", &params, &result, instance);
...
urEventGetProfilingInfo(
    ...
    uint64_t instance = context.notify_begin(32, "urEventGetProfilingInfo", &params);

    ur_result_t result = pfnGetProfilingInfo(hEvent, propName, propValueSize, pPropValue, pPropValueSizeRet);

    context.notify_end(32, "urEventGetProfilingInfo", &params, &result, instance);
...
urEventWait(
    ...
    uint64_t instance = context.notify_begin(33, "urEventWait", &params);

    ur_result_t result = pfnWait(numEvents, phEventWaitList);

    context.notify_end(33, "urEventWait", &params, &result, instance);
...
urEventRetain(
    ...
    uint64_t instance = context.notify_begin(34, "urEventRetain", &params);

    ur_result_t result = pfnRetain(hEvent);

    context.notify_end(34, "urEventRetain", &params, &result, instance);
...
urEventRelease(
    ...
    uint64_t instance = context.notify_begin(35, "urEventRelease", &params);

    ur_result_t result = pfnRelease(hEvent);

    context.notify_end(35, "urEventRelease", &params, &result, instance);
...
urEventGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(36, "urEventGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hEvent, phNativeEvent);

    context.notify_end(36, "urEventGetNativeHandle", &params, &result, instance);
...
urEventCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(37, "urEventCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeEvent, hContext, phEvent);

    context.notify_end(37, "urEventCreateWithNativeHandle", &params, &result, instance);
...
urEventSetCallback(
    ...
    uint64_t instance = context.notify_begin(38, "urEventSetCallback", &params);

    ur_result_t result = pfnSetCallback(hEvent, execStatus, pfnNotify, pUserData);

    context.notify_end(38, "urEventSetCallback", &params, &result, instance);
...
urMemImageCreate(
    ...
    uint64_t instance = context.notify_begin(39, "urMemImageCreate", &params);

    ur_result_t result = pfnImageCreate(hContext, flags, pImageFormat, pImageDesc, pHost, phMem);

    context.notify_end(39, "urMemImageCreate", &params, &result, instance);
...
urMemBufferCreate(
    ...
    uint64_t instance = context.notify_begin(40, "urMemBufferCreate", &params);

    ur_result_t result = pfnBufferCreate(hContext, flags, size, pHost, phBuffer);

    context.notify_end(40, "urMemBufferCreate", &params, &result, instance);
...
urMemRetain(
    ...
    uint64_t instance = context.notify_begin(41, "urMemRetain", &params);

    ur_result_t result = pfnRetain(hMem);

    context.notify_end(41, "urMemRetain", &params, &result, instance);
...
urMemRelease(
    ...
    uint64_t instance = context.notify_begin(42, "urMemRelease", &params);

    ur_result_t result = pfnRelease(hMem);

    context.notify_end(42, "urMemRelease", &params, &result, instance);
...
urMemBufferPartition(
    ...
    uint64_t instance = context.notify_begin(43, "urMemBufferPartition", &params);

    ur_result_t result = pfnBufferPartition(hBuffer, flags, bufferCreateType, pBufferCreateInfo, phMem);

    context.notify_end(43, "urMemBufferPartition", &params, &result, instance);
...
urMemGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(44, "urMemGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hMem, phNativeMem);

    context.notify_end(44, "urMemGetNativeHandle", &params, &result, instance);
...
urMemCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(45, "urMemCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeMem, hContext, phMem);

    context.notify_end(45, "urMemCreateWithNativeHandle", &params, &result, instance);
...
urMemGetInfo(
    ...
    uint64_t instance = context.notify_begin(46, "urMemGetInfo", &params);

    ur_result_t result = pfnGetInfo(hMemory, MemInfoType, propSize, pMemInfo, pPropSizeRet);

    context.notify_end(46, "urMemGetInfo", &params, &result, instance);
...
urMemImageGetInfo(
    ...
    uint64_t instance = context.notify_begin(47, "urMemImageGetInfo", &params);

    ur_result_t result = pfnImageGetInfo(hMemory, ImgInfoType, propSize, pImgInfo, pPropSizeRet);

    context.notify_end(47, "urMemImageGetInfo", &params, &result, instance);
...
urTearDown(
    ...
    uint64_t instance = context.notify_begin(48, "urTearDown", &params);

    ur_result_t result = pfnTearDown(pParams);

    context.notify_end(48, "urTearDown", &params, &result, instance);
...
urQueueGetInfo(
    ...
    uint64_t instance = context.notify_begin(49, "urQueueGetInfo", &params);

    ur_result_t result = pfnGetInfo(hQueue, propName, propValueSize, pPropValue, pPropSizeRet);

    context.notify_end(49, "urQueueGetInfo", &params, &result, instance);
...
urQueueCreate(
    ...
    uint64_t instance = context.notify_begin(50, "urQueueCreate", &params);

    ur_result_t result = pfnCreate(hContext, hDevice, pProps, phQueue);

    context.notify_end(50, "urQueueCreate", &params, &result, instance);
...
urQueueRetain(
    ...
    uint64_t instance = context.notify_begin(51, "urQueueRetain", &params);

    ur_result_t result = pfnRetain(hQueue);

    context.notify_end(51, "urQueueRetain", &params, &result, instance);
...
urQueueRelease(
    ...
    uint64_t instance = context.notify_begin(52, "urQueueRelease", &params);

    ur_result_t result = pfnRelease(hQueue);

    context.notify_end(52, "urQueueRelease", &params, &result, instance);
...
urQueueGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(53, "urQueueGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hQueue, phNativeQueue);

    context.notify_end(53, "urQueueGetNativeHandle", &params, &result, instance);
...
urQueueCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(54, "urQueueCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeQueue, hContext, phQueue);

    context.notify_end(54, "urQueueCreateWithNativeHandle", &params, &result, instance);
...
urQueueFinish(
    ...
    uint64_t instance = context.notify_begin(55, "urQueueFinish", &params);

    ur_result_t result = pfnFinish(hQueue);

    context.notify_end(55, "urQueueFinish", &params, &result, instance);
...
urQueueFlush(
    ...
    uint64_t instance = context.notify_begin(56, "urQueueFlush", &params);

    ur_result_t result = pfnFlush(hQueue);

    context.notify_end(56, "urQueueFlush", &params, &result, instance);
...
urSamplerCreate(
    ...
    uint64_t instance = context.notify_begin(57, "urSamplerCreate", &params);

    ur_result_t result = pfnCreate(hContext, pProps, phSampler);

    context.notify_end(57, "urSamplerCreate", &params, &result, instance);
...
urSamplerRetain(
    ...
    uint64_t instance = context.notify_begin(58, "urSamplerRetain", &params);

    ur_result_t result = pfnRetain(hSampler);

    context.notify_end(58, "urSamplerRetain", &params, &result, instance);
...
urSamplerRelease(
    ...
    uint64_t instance = context.notify_begin(59, "urSamplerRelease", &params);

    ur_result_t result = pfnRelease(hSampler);

    context.notify_end(59, "urSamplerRelease", &params, &result, instance);
...
urSamplerGetInfo(
    ...
    uint64_t instance = context.notify_begin(60, "urSamplerGetInfo", &params);

    ur_result_t result = pfnGetInfo(hSampler, propName, propValueSize, pPropValue, pPropSizeRet);

    context.notify_end(60, "urSamplerGetInfo", &params, &result, instance);
...
urSamplerGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(61, "urSamplerGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hSampler, phNativeSampler);

    context.notify_end(61, "urSamplerGetNativeHandle", &params, &result, instance);
...
urSamplerCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(62, "urSamplerCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeSampler, hContext, phSampler);

    context.notify_end(62, "urSamplerCreateWithNativeHandle", &params, &result, instance);
...
urUSMHostAlloc(
    ...
    ur_usm_host_alloc_params_t params = {&hContext, &pUSMFlag, &size, &align, &ppMem};
    uint64_t instance = context.notify_begin(63, "urUSMHostAlloc", &params);

    ur_result_t result = pfnHostAlloc(hContext, pUSMFlag, size, align, ppMem);

    context.notify_end(63, "urUSMHostAlloc", &params, &result, instance);
...
urUSMDeviceAlloc(
    ...
    ur_usm_device_alloc_params_t params = {&hContext, &hDevice, &pUSMProp, &size, &align, &ppMem};
    uint64_t instance = context.notify_begin(64, "urUSMDeviceAlloc", &params);

    ur_result_t result = pfnDeviceAlloc(hContext, hDevice, pUSMProp, size, align, ppMem);

    context.notify_end(64, "urUSMDeviceAlloc", &params, &result, instance);
...
urUSMSharedAlloc(
    ...
    ur_usm_shared_alloc_params_t params = {&hContext, &hDevice, &pUSMProp, &size, &align, &ppMem};
    uint64_t instance = context.notify_begin(65, "urUSMSharedAlloc", &params);

    ur_result_t result = pfnSharedAlloc(hContext, hDevice, pUSMProp, size, align, ppMem);

    context.notify_end(65, "urUSMSharedAlloc", &params, &result, instance);
...
urUSMFree(
    ...
    uint64_t instance = context.notify_begin(66, "urUSMFree", &params);

    ur_result_t result = pfnFree(hContext, pMem);

    context.notify_end(66, "urUSMFree", &params, &result, instance);
...
urUSMGetMemAllocInfo(
    ...
    uint64_t instance = context.notify_begin(67, "urUSMGetMemAllocInfo", &params);

    ur_result_t result = pfnGetMemAllocInfo(hContext, pMem, propName, propValueSize, pPropValue, pPropValueSizeRet);

    context.notify_end(67, "urUSMGetMemAllocInfo", &params, &result, instance);
...
urDeviceGet(
    ...
    uint64_t instance = context.notify_begin(68, "urDeviceGet", &params);

    ur_result_t result = pfnGet(hPlatform, DeviceType, NumEntries, phDevices, pNumDevices);

    context.notify_end(68, "urDeviceGet", &params, &result, instance);
...
urDeviceGetInfo(
    ...
    uint64_t instance = context.notify_begin(69, "urDeviceGetInfo", &params);

    ur_result_t result = pfnGetInfo(hDevice, infoType, propSize, pDeviceInfo, pPropSizeRet);

    context.notify_end(69, "urDeviceGetInfo", &params, &result, instance);
...
urDeviceRetain(
    ...
    uint64_t instance = context.notify_begin(70, "urDeviceRetain", &params);

    ur_result_t result = pfnRetain(hDevice);

    context.notify_end(70, "urDeviceRetain", &params, &result, instance);
...
urDeviceRelease(
    ...
    uint64_t instance = context.notify_begin(71, "urDeviceRelease", &params);

    ur_result_t result = pfnRelease(hDevice);

    context.notify_end(71, "urDeviceRelease", &params, &result, instance);
...
urDevicePartition(
    ...
    uint64_t instance = context.notify_begin(72, "urDevicePartition", &params);

    ur_result_t result = pfnPartition(hDevice, pProperties, NumDevices, phSubDevices, pNumDevicesRet);

    context.notify_end(72, "urDevicePartition", &params, &result, instance);
...
urDeviceSelectBinary(
    ...
    uint64_t instance = context.notify_begin(73, "urDeviceSelectBinary", &params);

    ur_result_t result = pfnSelectBinary(hDevice, ppBinaries, NumBinaries, pSelectedBinary);

    context.notify_end(73, "urDeviceSelectBinary", &params, &result, instance);
...
urDeviceGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(74, "urDeviceGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hDevice, phNativeDevice);

    context.notify_end(74, "urDeviceGetNativeHandle", &params, &result, instance);
...
urDeviceCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(75, "urDeviceCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeDevice, hPlatform, phDevice);

    context.notify_end(75, "urDeviceCreateWithNativeHandle", &params, &result, instance);
...
urDeviceGetGlobalTimestamps(
    ...
    uint64_t instance = context.notify_begin(76, "urDeviceGetGlobalTimestamps", &params);

    ur_result_t result = pfnGetGlobalTimestamps(hDevice, pDeviceTimestamp, pHostTimestamp);

    context.notify_end(76, "urDeviceGetGlobalTimestamps", &params, &result, instance);
...
urKernelCreate(
    ...
    uint64_t instance = context.notify_begin(77, "urKernelCreate", &params);

    ur_result_t result = pfnCreate(hProgram, pKernelName, phKernel);

    context.notify_end(77, "urKernelCreate", &params, &result, instance);
...
urKernelSetArgValue(
    ...
    uint64_t instance = context.notify_begin(78, "urKernelSetArgValue", &params);

    ur_result_t result = pfnSetArgValue(hKernel, argIndex, argSize, pArgValue);

    context.notify_end(78, "urKernelSetArgValue", &params, &result, instance);
...
urKernelSetArgLocal(
    ...
    uint64_t instance = context.notify_begin(79, "urKernelSetArgLocal", &params);

    ur_result_t result = pfnSetArgLocal(hKernel, argIndex, argSize);

    context.notify_end(79, "urKernelSetArgLocal", &params, &result, instance);
...
urKernelGetInfo(
    ...
    uint64_t instance = context.notify_begin(80, "urKernelGetInfo", &params);

    ur_result_t result = pfnGetInfo(hKernel, propName, propSize, pKernelInfo, pPropSizeRet);

    context.notify_end(80, "urKernelGetInfo", &params, &result, instance);
...
urKernelGetGroupInfo(
    ...
    uint64_t instance = context.notify_begin(81, "urKernelGetGroupInfo", &params);

    ur_result_t result = pfnGetGroupInfo(hKernel, hDevice, propName, propSize, pPropValue, pPropSizeRet);

    context.notify_end(81, "urKernelGetGroupInfo", &params, &result, instance);
...
urKernelGetSubGroupInfo(
    ...
    uint64_t instance = context.notify_begin(82, "urKernelGetSubGroupInfo", &params);

    ur_result_t result = pfnGetSubGroupInfo(hKernel, hDevice, propName, propSize, pPropValue, pPropSizeRet);

    context.notify_end(82, "urKernelGetSubGroupInfo", &params, &result, instance);
...
urKernelRetain(
    ...
    uint64_t instance = context.notify_begin(83, "urKernelRetain", &params);

    ur_result_t result = pfnRetain(hKernel);

    context.notify_end(83, "urKernelRetain", &params, &result, instance);
...
urKernelRelease(
    ...
    uint64_t instance = context.notify_begin(84, "urKernelRelease", &params);

    ur_result_t result = pfnRelease(hKernel);

    context.notify_end(84, "urKernelRelease", &params, &result, instance);
...
urKernelSetArgPointer(
    ...
    uint64_t instance = context.notify_begin(85, "urKernelSetArgPointer", &params);

    ur_result_t result = pfnSetArgPointer(hKernel, argIndex, argSize, pArgValue);

    context.notify_end(85, "urKernelSetArgPointer", &params, &result, instance);
...
urKernelSetExecInfo(
    ...
    uint64_t instance = context.notify_begin(86, "urKernelSetExecInfo", &params);

    ur_result_t result = pfnSetExecInfo(hKernel, propName, propSize, pPropValue);

    context.notify_end(86, "urKernelSetExecInfo", &params, &result, instance);
...
urKernelSetArgSampler(
    ...
    uint64_t instance = context.notify_begin(87, "urKernelSetArgSampler", &params);

    ur_result_t result = pfnSetArgSampler(hKernel, argIndex, hArgValue);

    context.notify_end(87, "urKernelSetArgSampler", &params, &result, instance);
...
urKernelSetArgMemObj(
    ...
    uint64_t instance = context.notify_begin(88, "urKernelSetArgMemObj", &params);

    ur_result_t result = pfnSetArgMemObj(hKernel, argIndex, hArgValue);

    context.notify_end(88, "urKernelSetArgMemObj", &params, &result, instance);
...
urKernelGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(89, "urKernelGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hKernel, phNativeKernel);

    context.notify_end(89, "urKernelGetNativeHandle", &params, &result, instance);
...
urKernelCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(90, "urKernelCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeKernel, hContext, phKernel);

    context.notify_end(90, "urKernelCreateWithNativeHandle", &params, &result, instance);
...
urModuleCreate(
    ...
    uint64_t instance = context.notify_begin(91, "urModuleCreate", &params);

    ur_result_t result = pfnCreate(hContext, pIL, length, pOptions, pfnNotify, pUserData, phModule);

    context.notify_end(91, "urModuleCreate", &params, &result, instance);
...
urModuleRetain(
    ...
    uint64_t instance = context.notify_begin(92, "urModuleRetain", &params);

    ur_result_t result = pfnRetain(hModule);

    context.notify_end(92, "urModuleRetain", &params, &result, instance);
...
urModuleRelease(
    ...
    uint64_t instance = context.notify_begin(93, "urModuleRelease", &params);

    ur_result_t result = pfnRelease(hModule);

    context.notify_end(93, "urModuleRelease", &params, &result, instance);
...
urModuleGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(94, "urModuleGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hModule, phNativeModule);

    context.notify_end(94, "urModuleGetNativeHandle", &params, &result, instance);
...
urModuleCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(95, "urModuleCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeModule, hContext, phModule);

    context.notify_end(95, "urModuleCreateWithNativeHandle", &params, &result, instance);
...
urPlatformGet(
    ...
    uint64_t instance = context.notify_begin(96, "urPlatformGet", &params);

    ur_result_t result = pfnGet(NumEntries, phPlatforms, pNumPlatforms);

    context.notify_end(96, "urPlatformGet", &params, &result, instance);
...
urPlatformGetInfo(
    ...
    uint64_t instance = context.notify_begin(97, "urPlatformGetInfo", &params);

    ur_result_t result = pfnGetInfo(hPlatform, PlatformInfoType, Size, pPlatformInfo, pSizeRet);

    context.notify_end(97, "urPlatformGetInfo", &params, &result, instance);
...
urPlatformGetApiVersion(
    ...
    uint64_t instance = context.notify_begin(98, "urPlatformGetApiVersion", &params);

    ur_result_t result = pfnGetApiVersion(hDriver, pVersion);

    context.notify_end(98, "urPlatformGetApiVersion", &params, &result, instance);
...
urPlatformGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(99, "urPlatformGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hPlatform, phNativePlatform);

    context.notify_end(99, "urPlatformGetNativeHandle", &params, &result, instance);
...
urPlatformCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(100, "urPlatformCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativePlatform, phPlatform);

    context.notify_end(100, "urPlatformCreateWithNativeHandle", &params, &result, instance);
...
urGetLastResult(
    ...
    uint64_t instance = context.notify_begin(101, "urGetLastResult", &params);

    ur_result_t result = pfnGetLastResult(hPlatform, ppMessage);

    context.notify_end(101, "urGetLastResult", &params, &result, instance);
...
urProgramCreate(
    ...
    uint64_t instance = context.notify_begin(102, "urProgramCreate", &params);

    ur_result_t result = pfnCreate(hContext, count, phModules, pOptions, pProperties, phProgram);

    context.notify_end(102, "urProgramCreate", &params, &result, instance);
...
urProgramCreateWithBinary(
    ...
    uint64_t instance = context.notify_begin(103, "urProgramCreateWithBinary", &params);

    ur_result_t result = pfnCreateWithBinary(hContext, hDevice, size, pBinary, pProperties, phProgram);

    context.notify_end(103, "urProgramCreateWithBinary", &params, &result, instance);
...
urProgramRetain(
    ...
    uint64_t instance = context.notify_begin(104, "urProgramRetain", &params);

    ur_result_t result = pfnRetain(hProgram);

    context.notify_end(104, "urProgramRetain", &params, &result, instance);
...
urProgramRelease(
    ...
    uint64_t instance = context.notify_begin(105, "urProgramRelease", &params);

    ur_result_t result = pfnRelease(hProgram);

    context.notify_end(105, "urProgramRelease", &params, &result, instance);
...
urProgramGetFunctionPointer(
    ...
    uint64_t instance = context.notify_begin(106, "urProgramGetFunctionPointer", &params);

    ur_result_t result = pfnGetFunctionPointer(hDevice, hProgram, pFunctionName, ppFunctionPointer);

    context.notify_end(106, "urProgramGetFunctionPointer", &params, &result, instance);
...
urProgramGetInfo(
    ...
    uint64_t instance = context.notify_begin(107, "urProgramGetInfo", &params);

    ur_result_t result = pfnGetInfo(hProgram, propName, propSize, pProgramInfo, pPropSizeRet);

    context.notify_end(107, "urProgramGetInfo", &params, &result, instance);
...
urProgramGetBuildInfo(
    ...
    uint64_t instance = context.notify_begin(108, "urProgramGetBuildInfo", &params);

    ur_result_t result = pfnGetBuildInfo(hProgram, hDevice, propName, propSize, pPropValue, pPropSizeRet);

    context.notify_end(108, "urProgramGetBuildInfo", &params, &result, instance);
...
urProgramSetSpecializationConstant(
    ...
    uint64_t instance = context.notify_begin(109, "urProgramSetSpecializationConstant", &params);

    ur_result_t result = pfnSetSpecializationConstant(hProgram, specId, specSize, pSpecValue);

    context.notify_end(109, "urProgramSetSpecializationConstant", &params, &result, instance);
...
urProgramGetNativeHandle(
    ...
    uint64_t instance = context.notify_begin(110, "urProgramGetNativeHandle", &params);

    ur_result_t result = pfnGetNativeHandle(hProgram, phNativeProgram);

    context.notify_end(110, "urProgramGetNativeHandle", &params, &result, instance);
...
urProgramCreateWithNativeHandle(
    ...
    uint64_t instance = context.notify_begin(111, "urProgramCreateWithNativeHandle", &params);

    ur_result_t result = pfnCreateWithNativeHandle(hNativeProgram, hContext, phProgram);

    context.notify_end(111, "urProgramCreateWithNativeHandle", &params, &result, instance);
...
urInit(
    ...
    uint64_t instance = context.notify_begin(112, "urInit", &params);

    ur_result_t result = pfnInit(device_flags);

    context.notify_end(112, "urInit", &params, &result, instance);
