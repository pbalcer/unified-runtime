...
namespace driver
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    /// @brief Intercept function for urEventCreate
    __urdlllocal ur_result_t UR_APICALL
    urEventCreate(
        ...
        )
    {
        ...
        // if the driver has created a custom function, then call it instead of using the generic path
        auto pfnCreate = d_context.urDdiTable.Event.pfnCreate;
        if( nullptr != pfnCreate )
        {
            result = pfnCreate( hContext, phEvent );
        }
        else
        {
            // generic implementation
    ...
    )
{
    ...
    pDdiTable->pfnCreate                                 = driver::urEventCreate;
